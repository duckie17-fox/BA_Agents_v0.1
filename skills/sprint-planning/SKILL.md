...
### VISI Sprint 1 — 18/05 – 29/05/2026

**Team:** 6 AI Engineer + 1 Intern (BAPO team không tính vào capacity AI)
**Capacity:** ~75% utilization

**Sprint Goal:**
> Ra mắt công cụ phân tích hình ảnh thông minh đầu tiên cho SBC — tự động xử lý 1.000 ảnh thực tế bằng AI và giao kết quả đúng hạn — đồng thời mở rộng nền tảng sang thị trường mỹ phẩm với POC đầu tiên cho TINVIET.

**Demo items:**
1. Pipeline SBC tự động xử lý 1.000 ảnh thực tế → xuất báo cáo kết quả
2. AI nhận diện kệ SPVB có shelf talker (tính năng mới)
3. TINVIET tenant kết nối hệ thống + AI nhận diện 10 SKU mỹ phẩm (POC)

**Wording note:** Sprint goal và demo items dùng ngôn ngữ cấp CEO — kết quả kinh doanh, không dùng thuật ngữ kỹ thuật.
